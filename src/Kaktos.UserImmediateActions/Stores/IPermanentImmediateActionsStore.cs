...
namespace Kaktos.UserImmediateActions.Stores
{
    public interface IPermanentImmediateActionsStore
    {
        ...
        /// <param name="expirationTimeUtc">Expiration time that is passed to the Add method of <see cref="IImmediateActionsStore"/>.</param>
        ...
        /// <param name="expirationTimeUtc">Expiration time that is passed to the AddAsync method of <see cref="IImmediateActionsStore"/>.</param>
