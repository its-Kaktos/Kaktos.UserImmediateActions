...
namespace UserImmediateActions.UnitTest.Stores
{
    public class MemoryCacheImmediateActionsStoreTests
    {
        ...
        public void Add_ShouldCall_CreateEntry()
        {
            ...
            // Act
            _sut.Add(key, new ImmediateActionDataModel(_dateTimeNow, AddPurpose.RefreshCookie));
        ...
        public async Task AddAsync_ShouldCall_CreateEntry()
        {
            ...
            // Act
            await _sut.AddAsync(key, new ImmediateActionDataModel(_dateTimeNow, AddPurpose.RefreshCookie));
